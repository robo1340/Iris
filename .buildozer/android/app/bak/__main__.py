...
#bitrate = os.environ.get('BITRATE', 2)
...
def create_parser(description, interface_factory):
	...
	calibration_help = ('Run calibration (specify "auto" for automatic gain control)')

	for sub in subparsers.choices.values():
		sub.add_argument('-c', '--calibrate', nargs='?', default=False, metavar='SYSTEM', help=calibration_help)
		sub.add_argument('-l', '--audio-library', default='libportaudio-2.dll', help='File name of PortAudio shared library.')
		sub.add_argument('-z', '--zlib', default=False, action='store_true', help='Use zlib to compress/decompress data.')
