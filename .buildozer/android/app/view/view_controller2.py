...
class ViewController():
    ...
    def ack_msg_handler(self, address, *args):
        print('received an acknoweledgement message from the service')
        self.ui.addAckToUI((args[0],args[1],args[2]))       
