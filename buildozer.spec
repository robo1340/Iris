...
#source.include_exts = py,png,jpg,kv,atlas,ini,so,java,aidl
...
# (list) Permissions
android.permissions = RECORD_AUDIO,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,ACCESS_FINE_LOCATION,INTERNET,VIBRATE,MODIFY_AUDIO_SETTINGS,FOREGROUND_SERVICE
...
android.add_src = OsmAndHelper.java, OsmAndAidlHelper.java
...
#android.add_libs_armeabi = libportaudio.so
