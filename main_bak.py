...
if __name__ == "__main__":
    ...
    request_permissions([Permission.ACCESS_FINE_LOCATION, Permission.RECORD_AUDIO, Permission.READ_EXTERNAL_STORAGE, Permission.WRITE_EXTERNAL_STORAGE])
    ...
    use_tkinter = False
    ini_config = parseConfigFile('config.ini')
    ...
    ui_thread = common.StoppableThread(target = view_controller_func, args=(ui, il2p, ini_config, gps))
